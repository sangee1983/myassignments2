...
public class DuplicateLead {
	...
	System.out.println(title1);
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("TestLeaf Duplicate");
		
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("sangeethaDuplicate");
